...
from resources import MainPageView, RolesView, RoleByIdView, UsersView, UserByIdView, EventsView, EventByIdView, \
    StagesView, StageByIdView, PerformancesView, PerformanceByIdView, MaterialsView, MaterialByIdView
...
performances.add_route(PerformanceByIdView.as_view(), '/<performance_id>',  strict_slashes=False)
...
materials.add_route(MaterialByIdView.as_view(), '/<material_id>',  strict_slashes=False)
